...
export default function Experience() {
  const items = [
    {
      dot: (
        <div className=" w-[15px] h-[15px] rounded-full bg-gray-200 flex-shrink-0" />
      ),
      children: (
        <div className=" md:pr-[1rem]">
          <div className=" flex justify-between items-center">
            ...
            <div className=" text-gray-300 mt-1 md:mt-0 text-[0.7rem] md:text-[1rem]">
              Aug 2024 - Nov 2024
            </div>
          </div>
          <div className=" flex flex-col gap-[10px] mt-3">
            ...
            <CustomPoint>
              <div>
                Developed an E-Cart Application from scratch, implementing
                product listing, search, cart management, shipping details, and
                a <Highlight text={"Razorpay payment gateway"} />.
              </div>
            </CustomPoint>
            <CustomPoint>
              <div>
                Created a <Highlight text={"responsive"} /> landing page for an
                educational website in close collaboration with UI/UX designers,
            ...
            <CustomPoint>
              <div>
                ...
                <Highlight text={"Framer Motion"} /> , delivering a highly
      ...
      children: (
        <div className=" md:pr-[1rem]">
          ...
          <div className=" flex flex-col gap-[10px] mt-3">
            ...
            <CustomPoint>
              <div>
                Collaborated in frontend development for a Debate Management
                Application, taking full responsibility for the User Dashboard.
              </div>
            </CustomPoint>
            <CustomPoint>
              <div>
