  ...
  const ProjectData = [
    {
      ...
      intro:
        " Developed a Job Portal with features for users to view, filter, and apply for jobs, manage profiles (including profile picture and resume), and explore similar job opportunities, and for employers to post jobs, manage company profiles, and view applicant profiles with resumes.",
      subPoints: (
        <>
          <CustomPoint>
            <div>
              Implemented <Highlight text={"JWT auth"} />
              entication, and <Highlight text={"bycrypt"} /> to ensure secure
              login for both users and employers, protecting personal and
              company data.
            </div>
          </CustomPoint>
          <CustomPoint>
            <div>
              ...
              and <Highlight text={"Firebase"} /> for handling profile picture
              and resume uploads in the backend.
            </div>
          </CustomPoint>
          <CustomPoint>
            <div>
              ...
              {""}
              using <Highlight
                text={"Next.js, Redux Toolkit, Tailwind CSS,"}
              />{" "}
              and <Highlight text={"Ant Design"} /> and enhanced user
              interaction with <Highlight text={"Framer Motion"} />
            </div>
          </CustomPoint>
          <div className=" text-gray-100 mt-3">
            <span className=" text-gray-200 text-[1.1rem]">Tech Stack:</span>{" "}
            Next.js, <Highlight text={"TypeScript"} />, Tailwind CSS, Node.js,{" "}
            <Highlight text={"MongoDB"} /> ,{""} Express.js, Firebase, Framer
            Motion, Ant Design, JWT, Redux Toolkit, bcrypt.
          </div>
        </>
      ),
      image: jobNow,
    ...
    },
    {
      ...
      intro:
        "This is a responsive web application built using React JS. It can alarm and give notifications when the device's battery level reaches a user-specified percentage. The app also allows to choose the alarm audio from the user's device.",
      subPoints: (
        <>
          <CustomPoint>
            <div>
              Implemented battery level monitoring using{" "}
              <Highlight text={"React hooks"} /> like useState and useEffect for
              real-time updates.
            </div>
          </CustomPoint>
          <CustomPoint>
            <div>
              Integrated <Highlight text={"Context API"} /> for managing
              application-wide state related to battery notifications.
            </div>
          </CustomPoint>
          <CustomPoint>
            <div>
              Implemented file handling with{" "}
              <Highlight text={"File Reader API"} /> to allow users to select
              custom alarm sounds.
            </div>
          </CustomPoint>
          <CustomPoint>
          ...
          <div className="text-gray-300 font-thin mt-3">
            <span className="text-gray-200 text-[1.1rem] font-medium">
              Tech Stack:
            </span>{" "}
            React JS, Navigation API, File Reader API, Tailwind CSS, antd,
            react-icons
          </div>
        </>
      ),
    ...
    },
    {
      ...
      intro:
        "This is a web application built using React JS that fetches news from all over the world. Users can fetch news according to their country and category choice. It includes major concepts of React like useState, useEffect, Infinite Scroll, Context API, and many more.",
      subPoints: (
        <>
          <CustomPoint>
            <div>
              Fetched news dynamically based on user's country and category
              using <Highlight text={"News API"} /> integration.
            </div>
          </CustomPoint>
          <CustomPoint>
            <div>
              Utilized <Highlight text={"React hooks"} /> like{" "}
              <Highlight text={"useState"} /> and{" "}
              <Highlight text={"useEffect"} /> for state management and
              lifecycle control.
            </div>
          </CustomPoint>
          <CustomPoint>
            <div>
              Implemented <Highlight text={"Infinite Scroll"} /> to enhance user
              experience while browsing continuous news content.
            </div>
          </CustomPoint>
          <CustomPoint>
            <div>
              Managed global state with <Highlight text={"Context API"} /> to
              enable country and category preferences throughout the app.
            </div>
          </CustomPoint>
          <div className="text-gray-300 font-thin mt-3">
            <span className="text-gray-200 text-[1.1rem] font-medium">
            ...
            React JS, useState, useEffect, Context API, Infinite Scroll, News
            API, Tailwind CSS
          </div>
        </>
      ),
